...
-- 106. See all the Customer (C) who has TerritoryID (C) is between 6 and 8, and has the AccountNumber (C) starts with two uppercase letters
SELECT *
FROM Sales.Customer
WHERE TerritoryID BETWEEN 6 AND 8 AND AccountNumber LIKE '[A-Z][A-Z]%'
